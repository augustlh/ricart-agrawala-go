...
### Warning
Please note that the implementation assumes that there is a reliable message delivery and no process failures (even thought this obviously is impossible in the real world as networks and computers are unreliable).
